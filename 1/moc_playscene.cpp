...
#include "../../../../architecture/BWshift/playscene.h"
...
QT_MOC_LITERAL(3, 16, 5), // "trans"
QT_MOC_LITERAL(4, 22, 11), // "timeinitial"
QT_MOC_LITERAL(5, 34, 11), // "btnsetting_"
QT_MOC_LITERAL(6, 46, 10), // "updatetime"
QT_MOC_LITERAL(7, 57, 11), // "receivepara"
QT_MOC_LITERAL(8, 69, 1), // "a"
QT_MOC_LITERAL(9, 71, 1) // "b"

    },
    "PlayScene\0back\0\0trans\0timeinitial\0"
    "btnsetting_\0updatetime\0receivepara\0a\0"
    "b"
};
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->trans(); break;
        case 2: _t->timeinitial(); break;
        case 3: _t->btnsetting_(); break;
        case 4: _t->updatetime(); break;
        case 5: _t->receivepara((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (PlayScene::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayScene::trans)) {
                *result = 1;
                return;
            }
        }
